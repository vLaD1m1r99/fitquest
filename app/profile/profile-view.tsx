...
import { xpProgress, type Profile, type RPG } from "@/lib/data"
...
export function ProfileView({ profile, rpg }: ProfileViewProps) {
				...
				{rpg.xpHistory.length > 0 ? (
					<div className="space-y-2">
						{[...rpg.xpHistory].reverse().map((entry, idx) => (
							<div key={idx} className="flex items-center justify-between p-3 rounded-md bg-muted/30 text-sm">
								<div>
